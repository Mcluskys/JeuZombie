...
# ------------------------------------------------------------
# Audio : réglages plus stables pour navigateur / PC / smartphone.
# pre_init doit être appelé AVANT pygame.init().
...
if AUDIO_OK:
    try:
        pygame.mixer.music.load("assets/musique.ogg")
        pygame.mixer.music.set_volume(0.45)

        zombie_sound = pygame.mixer.Sound("assets/cri_zombie.ogg")
        zombie_sound.set_volume(0.70)
